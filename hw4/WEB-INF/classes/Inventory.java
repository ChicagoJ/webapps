      ...
      String LOGOUT = "<li class=\"right\"><a href=\"./LogoutServlet\">Logout</a></li>";
            ...
            protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
                     ...
                     //       //add signup and login tag
                        ...
                        pw.println("<td>All products information</td>");
                        pw.println("<td>");
                        pw.println("<input type=\"hidden\" name=\"tableType\" value=\"table1\">");
                        pw.println("<input type=\"submit\" value=\"submit\"></td></form></tr>");

                        pw.println("<tr><form action=\"./ReportServlet\">");
                        pw.println("<td>Products on sales</td>");
                        pw.println("<td>");
                        pw.println("<input type=\"hidden\" name=\"tableType\" value=\"table2\">");
                        pw.println("<input type=\"submit\" value=\"submit\"></td></form></tr>");

                        pw.println("<tr><form action=\"./ReportServlet\">");
                        pw.println("<td>Products where has manufacturer Rebates</td>");
                        pw.println("<td>");
                        pw.println("<input type=\"hidden\" name=\"tableType\" value=\"table3\">");
                        pw.println("<input type=\"submit\" value=\"submit\"></td></form></tr>");

                        pw.println("<tr><form action=\"./testBar\">");
                        pw.println("<td>the total number of items available for every product</td>");
                        pw.println("<td>");
