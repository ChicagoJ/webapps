...
<body>
	...
	<div class="header">
		<div class="top-header">
			<div class="container">
				<div class="logo">
					<a href="index.jsp"><font size="6" color="yellow"><%=Constant.NAME %> HOTELS</font></a>
				...
				<div class="top-menu">
					<ul>
						...
						<li class="scroll"><a href="roomCart.jsp">CART <%=(cart != null && !cart.isEmpty() ? "(" + cart.getRoomNumber() + ")" : "") %></a></li>
	...
	<script>
		...
		$(function() {
			...
			$(":text").change(function(){
				...
				var args = {"method":"updateCart","roomId":roomIdStr, "quantity":quantityVal, "time":new Date()};
	...
	<div id="body">
		<section id="content">
			...
			%>
				...
				<div>Total Cost: <font color="red" id="totalCost">$<%=String.format("%.2f", cart.getTotalCost()) %></font></div>
				...
				%>
					<tr>
						...
						<td align="center"><%=String.format("%.2f", cartRoom.getRoomCost()) %></td>
