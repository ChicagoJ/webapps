...
public class Utilities {
    ...
    public static String PrintSidebar(){
        ...
        str += "<li class=\"text\">";
        str += "<form name=\"autofillform\" action=\"autocomplete\"><table><tbody><tr><td>";
        str += "<input type=\"text\" size=\"31\" value=\"\" id=\"complete-field\" onkeyup=\"doCompletion()\"/>";
        str += "</td></tr>";
        str += "<tr><td id=\"auto-row\" colspan=\"2\"><table id=\"complete-table\" class=\"popupBox\" />";
